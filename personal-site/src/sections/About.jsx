...
export default function About() {
  return (
    <section
      id="about"
      className="min-h-[100svh] bg-indigo-950 flex px-4 py-10 sm:px-6 md:px-8 md: lg:px-12"
    >
      ...
      md:flex-row md:justify-between lg:gap-16">
        ...
        <img
          ...
          className="w-full max-w-xs rounded-lg object-cover sm:max-w-sm md:max-w-md lg:max-w-[500px]"
        />
      </div>
    </section>
  );
